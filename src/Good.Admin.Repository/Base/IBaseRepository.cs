...
namespace Good.Admin.Repository
{
    ...
    public interface IBaseRepository<T> where T : class
    {
        ...
        List<TResult> QueryMuch<T1, T2, TResult>(
            ...
            Expressionable<T1, T2> whereLambda = null, bool blUseNoLock = false)
            where T1 : class, new()
            where T2 : class, new();
        ...
        Task<List<TResult>> QueryMuchAsync<T1, T2, TResult>(
            Expression<Func<T1, T2, object[]>> joinExpression,
            Expression<Func<T1, T2, TResult>> selectExpression,
            Expressionable<T1, T2> whereLambda, bool blUseNoLock = false)
            where T1 : class, new()
            where T2 : class, new();
        ...
        Task<PageResult<TResult>> QueryMuchPageAsync<T1, T2, TResult>(
         Expression<Func<T1, T2, object[]>> joinExpression,
         Expression<Func<T1, T2, TResult>> selectExpression,
         Expressionable<T1, T2> whereLambda = null,
         int pagenumber = 1,
        ...
        List<TResult> QueryMuch<T1, T2, T3, TResult>(
            ...
            Expressionable<T1, T2, T3> whereLambda = null, bool blUseNoLock = false)
            where T1 : class, new()
            where T2 : class, new()
            where T3 : class, new();
